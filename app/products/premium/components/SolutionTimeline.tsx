...
export function SolutionTimeline() {
  const phases = [
    ...
    {
      days: "Ден 31-60",
      title: "Стабилизация и видим напредък",
      description: "Хормоналната система се стабилизира. Резултатите стават очевидни.",
      results: [
    ...
    {
      days: "Ден 61-90",
      title: "Пълна оптимизация",
      description: "Промените са явни и стабилни. Новият ти нормален режим.",
      results: [
        "Мускулна маса и сила растат",
        "Либидото е на пиков ниво",
        "Уверен остта е върната",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            Как ПРЕМИУМ пакетът ще промени живота ти за 90 дни
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            3-месечна оптимизация. Стабилни резултати. Траен ефект.
          </p>
        </div>
          ...
          {phases.map((phase, index) => (
            <div key={index} className="relative">
              ...
              {index < phases.length - 1 && (
                <div className="absolute left-8 md:left-12 top-24 md:top-32 w-1 h-full bg-gradient-to-b from-violet-600 to-transparent" />
              )}
              ...
              <div className="flex gap-4 md:gap-6">
                ...
                <div className="flex-1 bg-background rounded-xl p-6 md:p-8 shadow-lg border border-border">
                  <div className="mb-4">
                    <span className="text-sm md:text-base font-bold text-violet-600">
                      {phase.days}
                    </span>
        ...
        {/* Final Message */}
        <div className="mt-12 md:mt-16 text-center bg-gradient-to-r from-violet-600/10 to-purple-600/10 rounded-xl p-6 md:p-10 border-2 border-violet-600/30">
          <p className="text-xl md:text-2xl font-bold mb-2">
            90 дни. Идеалният баланс между време и резултати.
          </p>
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Достатъчно време за стабилни промени. Оптимална инвестиция. Траен успех.
          </p>
        </div>
      </div>
    </section>
