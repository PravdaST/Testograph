          ...
          <div className="relative z-10">
            ...
            <div className="mt-8 sm:mt-10 md:mt-12 text-center space-y-4">
              <p className="text-base sm:text-lg md:text-xl text-muted-foreground font-semibold">
                Готов да промениш това за 90 дни?
              </p>
              <button
                onClick={() => {
                ...
                className="px-8 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-blue-500 via-pink-500 to-blue-500
                           ...
                           hover:shadow-blue-500/50 inline-flex items-center gap-2"
              >
