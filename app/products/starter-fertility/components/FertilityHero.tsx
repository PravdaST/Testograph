...
import { ArrowDown, TrendingUp, Users, Star, Shield, Baby } from "lucide-react";
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-background via-muted/10 to-background py-16 md:py-24 lg:py-32 px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 -right-20 w-80 h-80 bg-pink-500/20 rounded-full blur-3xl" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-blue-500/10 rounded-full blur-3xl" style={{ animationDelay: '2s' }} />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className={`space-y-8 transition-all duration-1000 ${
            ...
            <div className="inline-flex items-center gap-3 bg-green-500/10 border-2 border-green-500/30 rounded-full px-5 py-2.5 backdrop-blur-sm">
              ...
              <span className="text-sm md:text-base font-bold text-green-400">
                800+ мъже подобриха спермограмата си
              </span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl font-bold text-foreground">
                Но какво ако проблемът е измерим?
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-6 border-t border-border/50">
              {[
                { icon: Users, label: "Доволни клиенти", value: "800+", color: "text-green-500" },
                ...
                <div key={i} className="space-y-2 group hover:scale-105 transition-transform">
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/30 via-transparent to-pink-500/30 blur-3xl opacity-50" />
            ...
            <div className="relative">
              <div className="relative aspect-square rounded-3xl overflow-hidden border-2 border-border/50 shadow-2xl backdrop-blur-xl bg-card/30 hover:scale-105 transition-transform duration-700">
                <Image
                  ...
                  alt="TestoUP product - Natural fertility boost"
                  width={600}
                  height={600}
              ...
              <div className="absolute -top-6 -right-6 bg-card/95 backdrop-blur-xl rounded-2xl p-5 shadow-2xl border-2 border-blue-500/30 hover:scale-110 transition-transform">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground whitespace-nowrap">Подвижност за 90 дни</div>
                  </div>
                </div>
              </div>

              <div className="absolute -bottom-6 -left-6 bg-card/95 backdrop-blur-xl rounded-2xl p-5 shadow-2xl border-2 border-pink-500/30 hover:scale-110 transition-transform">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-pink-500/20 flex items-center justify-center">
                    <Baby className="w-6 h-6 text-pink-500" />
                  </div>
                  <div>
                    <div className="text-2xl font-black text-pink-500">800+</div>
                    <div className="text-xs text-muted-foreground whitespace-nowrap">Бащи след TestoUP</div>
                  </div>
                </div>
              </div>
