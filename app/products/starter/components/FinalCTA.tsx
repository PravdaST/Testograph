  ...
  return (
    <section id="final-cta" className="py-12 md:py-20 px-4 bg-gradient-to-br from-primary/5 via-transparent to-accent/5">
      <div className="max-w-5xl mx-auto">
        {/* Urgency Banner */}
        <div className="bg-gradient-to-r from-red-500 to-orange-600 rounded-xl p-4 mb-8 text-white text-center">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-muted/50 rounded-xl p-6">
                <div className="flex items-baseline justify-center gap-3 mb-4">
                  <span className="text-5xl md:text-6xl font-black">97</span>
                  <div>
                    <span className="text-2xl font-bold">лв</span>
                    <p className="line-through text-muted-foreground">264 лв</p>
                  </div>
                </div>
