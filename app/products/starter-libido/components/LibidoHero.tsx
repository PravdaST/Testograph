  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-background via-muted/10 to-background py-16 md:py-24 lg:py-32 px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 -right-20 w-80 h-80 bg-accent/20 rounded-full blur-3xl" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-primary/10 rounded-full blur-3xl" style={{ animationDelay: '2s' }} />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className={`space-y-8 transition-all duration-1000 ${
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black leading-[1.05] tracking-tight">
              ...
              <span className="relative inline-block mt-2">
                ...
                <div className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-to-r from-primary via-accent to-primary rounded-full blur-sm" />
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button
                ...
                className="group relative px-8 py-5 bg-gradient-to-r from-primary via-accent to-primary text-white rounded-2xl font-bold text-lg shadow-2xl hover:shadow-primary/50 transition-all duration-300 hover:scale-105 overflow-hidden"
              >
              ...
              <button
                ...
                className="px-8 py-5 border-2 border-primary/30 rounded-2xl font-semibold text-lg hover:bg-primary/5 hover:border-primary/50 transition-all duration-300 backdrop-blur-sm"
              >
                Прочети истории
              </button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-6 border-t border-border/50">
              {[
                { icon: Users, label: "Доволни клиенти", value: "3,247+", color: "text-green-500" },
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${
            ...
            <div className="relative">
              ...
              <div className="absolute -top-6 -right-6 bg-card/95 backdrop-blur-xl rounded-2xl p-5 shadow-2xl border-2 border-green-500/30 hover:scale-110 transition-transform">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-green-500/20 flex items-center justify-center">
                    <TrendingUp className="w-6 h-6 text-green-500" />
                  </div>
                  <div>
                    <div className="text-2xl font-black text-green-500">+47%</div>
              ...
              <div className="absolute -bottom-6 -left-6 bg-card/95 backdrop-blur-xl rounded-2xl p-5 shadow-2xl border-2 border-primary/30 hover:scale-110 transition-transform">
                <div className="flex items-center gap-3">
