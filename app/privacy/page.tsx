    ...
    <div className="min-h-screen bg-background py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">1. Въведение</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">2. Какви данни събираме</h2>

            <h3 className="text-xl font-semibold text-foreground mt-6 mb-3">2.1. Лични данни</h3>
            <p>Когато използвате нашия безплатен анализ или поръчвате продукти, ние можем да събираме:</p>
            ...
            <h3 className="text-xl font-semibold text-foreground mt-6 mb-3">2.2. Автоматично събрани данни</h3>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Cookies и tracking technologies</strong> - вижте нашата <a href="/cookies" className="text-primary hover:underline">Политика за бисквитки</a></li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">3. Как използваме Вашите данни</h2>
            <p>Ние използваме събраните данни за следните цели:</p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">4. Правно основание за обработка (GDPR)</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">5. Споделяне на данни с трети страни</h2>
            <p>Ние споделяме Вашите данни само с доверени партньори:</p>

            <h3 className="text-xl font-semibold text-foreground mt-6 mb-3">5.1. Използвани услуги</h3>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-foreground mt-6 mb-3">5.2. Трансфер на данни извън ЕС</h3>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">6. Съхранение на данните</h2>
            <p>Ние съхраняваме Вашите лични данни само толкова дълго, колкото е необходимо:</p>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Cookies</strong> - виж <a href="/cookies" className="text-primary hover:underline">Политика за бисквитки</a></li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">7. Вашите права (GDPR)</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">8. Сигурност на данните</h2>
            <p>Ние прилагаме технически и организационни мерки за защита на Вашите данни:</p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">9. Деца</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">10. Промени в политиката</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">11. Контакт</h2>
            <p>За въпроси относно тази Политика за поверителност или Вашите лични данни:</p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">12. Надзорен орган</h2>
            <p>
            ...
            <div className="bg-card border border-border rounded-lg p-6 mt-4">
              <p className="font-semibold text-foreground">Комисия за защита на личните данни</p>
              <p>Адрес: гр. София 1592, бул. "Проф. Цветан Лазаров" № 2</p>
              <p>Телефон: +359 2 915 3 518</p>
              <p>Email: <a href="mailto:kzld@cpdp.bg" className="text-primary hover:underline">kzld@cpdp.bg</a></p>
