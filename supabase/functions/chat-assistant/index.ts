...
- Ако питат КАК да поръчат - насочи към: "Можеш да поръчаш от нашия магазин: testograph.carrd.co"
...
4. ${websiteQuizData.hasQuiz
  ? `Ако питат за пълна програма, насочи към приложението с бутон: "Виждам че вече си попълнил теста." и добави [ACTION_BUTTON:Влез в приложението:https://app.testograph.eu]`
  : `Ако питат за пълна програма, насочи към quiz с бутон и добави [ACTION_BUTTON:Попълни безплатен тест:https://app.testograph.eu/quiz]`}
...
4. ПРОДАЖБА ПО МЕТОДА НА ALEX HORMOZI
   ...
   [ACTION_BUTTON:Започни 4-седмичната трансформация:https://testograph.carrd.co/]
...
6. ДВАТА ПРОДУКТА - КОГА КОЙ ДА ПРЕПОРЪЧАШ
   ...
   💰 ПЛАТЕНА ПРОГРАМА (https://testograph.carrd.co/)
