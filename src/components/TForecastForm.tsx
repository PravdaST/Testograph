              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  {errors.trainingFrequency && (
                    <p className="text-sm text-destructive mt-1">{errors.trainingFrequency}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.trainingType && (
                    <p className="text-sm text-destructive mt-1">{errors.trainingType}</p>
                  )}
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  />
                  {errors.averageSleep && (
                    <p className="text-sm text-destructive mt-1">{errors.averageSleep}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.diet && (
                    <p className="text-sm text-destructive mt-1">{errors.diet}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.alcohol && (
                    <p className="text-sm text-destructive mt-1">{errors.alcohol}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.nicotine && (
                    <p className="text-sm text-destructive mt-1">{errors.nicotine}</p>
                  )}
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  {errors.libido && (
                    <p className="text-sm text-destructive mt-1">{errors.libido}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.morningEnergy && (
                    <p className="text-sm text-destructive mt-1">{errors.morningEnergy}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.recovery && (
                    <p className="text-sm text-destructive mt-1">{errors.recovery}</p>
                  )}
                </div>
