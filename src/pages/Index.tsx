...
const Index = () => {
  ...
  return <div className="min-h-screen transition-none relative bg-gray-900">
          ...
          <div className="relative z-10 container mx-auto px-4 md:px-6 max-w-[1200px] py-14 md:py-20 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-12 items-start gap-8 xl:gap-10">
              ...
              <div className="lg:col-span-7 xl:col-span-7 flex flex-col justify-center h-full">
                ...
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-5 text-white leading-[1.1]">
                  Върни се към мъжа,
                  <br />
                ...
                <div className="bg-card/30 backdrop-blur-sm border border-primary/20 rounded-xl p-4 mb-6">
                  <div className="grid grid-cols-3 gap-3">
                    <div className="text-center">
                      ...
                      <p className="text-[10px] text-muted-foreground mt-0.5">Мъже</p>
                    </div>
                    <div className="text-center">
              ...
              {/* Right Content - Animated Visual Proof */}
      ...
      {/* Mobile Sticky CTA - Shows after scroll on mobile only, above ScarcityBanner */}
      {!showResults && showMobileCTA && (
        <div className="lg:hidden fixed bottom-20 left-4 right-4 z-50 animate-slide-up">
          <button
            onClick={() => setFormModalOpen(true)}
            className="w-full py-4 px-6 bg-gradient-to-r from-purple-600 to-violet-700 hover:from-purple-700 hover:to-violet-800 text-white font-bold text-lg rounded-full shadow-2xl shadow-purple-500/50 flex items-center justify-center gap-2 transition-all duration-300 hover:scale-105"
          >
