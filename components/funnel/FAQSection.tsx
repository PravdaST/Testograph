  ...
  const faqs: FAQ[] = [
    {
      ...
      answer: "Повечето мъже усещат първите промени след 14-21 дни. Пълният ефект - след 60-90 дни. Зависи колко строго следваш плана."
    },
    {
    ...
    },
    {
      ...
      answer: "15 минути сутрин. Толкова. Всичко е просто. Следваш плана и толкова."
    },
    {
      question: "Какво ако не съм доволен?",
      answer: "30 дни гаранция. Не харесваш резултата - изпращаш имейл, връщам парите. Без въпроси."
    },
    {
      question: "Защо не мога да намеря тези неща безплатно в интернет?",
      answer: "Можеш. Ще прекараш 6 месеца да четеш противоречива информация и да не знаеш на кого да вярваш. Или плащаш 197 лв и имаш точния план какво да правиш. Твой е изборът."
    },
    {
