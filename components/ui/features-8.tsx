            ...
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                <div className="relative">
                    ...
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="group relative col-span-full flex overflow-hidden lg:col-span-2 bg-gradient-card backdrop-blur-md border border-glass-border shadow-glass hover:shadow-glow transition-all duration-500 hover:scale-[1.02]">
                            {/* Shine overlay */}
                        ...
                        <Card className="group relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-gradient-card backdrop-blur-md border border-glass-border shadow-glass hover:shadow-glow transition-all duration-500 hover:scale-[1.02]">
                            {/* Shine overlay */}
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-out" />
                            <CardContent className="pt-6 flex flex-col h-full relative z-10">
                        ...
                        <Card className="group relative col-span-full overflow-hidden lg:col-span-3 bg-gradient-card backdrop-blur-md border border-glass-border shadow-glass hover:shadow-glow transition-all duration-500 hover:scale-[1.02]">
                            {/* Shine overlay */}
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-out" />
                            <CardContent className="grid pt-6 sm:grid-cols-2 relative z-10">
                        ...
                        <Card className="group relative col-span-full overflow-hidden lg:col-span-3 bg-gradient-card backdrop-blur-md border border-glass-border shadow-glass hover:shadow-glow transition-all duration-500 hover:scale-[1.02]">
                            {/* Shine overlay */}
                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-out" />
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2 relative z-10">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border border-muted/20 before:border-muted/10">
